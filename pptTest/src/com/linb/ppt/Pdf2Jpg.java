...
public class Pdf2Jpg {
    ...
    public static int tranfer(String sourceFile, String destFile)
            throws PDFException, PDFSecurityException, IOException {

        // ICEpdf document class

        String FileName = sourceFile.substring(
        ...
        for (int i = 0; i < document.getNumberOfPages(); i++) {
            img = (BufferedImage) document.getPageImage(i,
            ...
            File outFile = new File(destFile + FileName + "_" + (i + 1)
                    + ".png");
